...
function hashPassword(password, salt) {
  const finalSalt = salt || (0, import_crypto.randomBytes)(16).toString("hex");
  const hash = (0, import_crypto.pbkdf2Sync)(
    password,
    finalSalt,
    ITERATIONS,
    HASH_LENGTH,
...
function generateToken(payload, expiresInHours = 24) {
  ...
  const hmac = (0, import_crypto.createHmac)("sha256", SECRET_SIGN_KEY);
